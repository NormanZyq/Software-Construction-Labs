...
public class TrackGameTest {
    ...
    public void testAddAthlete() throws AthleteDidExistException {
        ...
        Athlete a = PhysicalObjectPool.getInstance().athlete("A", 1, "USA", 36, 12);
    ...
    public void testAddTrack() throws FileNotFoundException, OrbitFileParseException {
        TrackGame trackGame = (TrackGame) FileParser.parseFile(new TrackGameScannerParser(), new File("test/txt/TrackGame.txt"));
        try {
