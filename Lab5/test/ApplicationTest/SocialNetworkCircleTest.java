...
public class SocialNetworkCircleTest implements OrbitableTest {
    ...
    public void testConstructor() {
        try {
            ...
            SocialPerson p = PhysicalObjectPool.getInstance().person("Bob", 19, 'M');
    ...
    public void testAddCenterObject() {
        ...
        // 1
        SocialPerson p1 = PhysicalObjectPool.getInstance().person("Bob", 20, 'M');
        assertTrue(circle.addCenterUser(p1));

        // 2
        SocialPerson p2 = PhysicalObjectPool.getInstance().person("Mary", 21, 'F');
     ...
     */
    @Test
    public void testAddRelation() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();

//        SocialPerson center = PhysicalObjectPool.getInstance().person("Center", 100, 'M');


        SocialPerson p1 = PhysicalObjectPool.getInstance().person("Bob", 18, 'M');
        circle.addCenterUser(p1);
        SocialPerson p2 = PhysicalObjectPool.getInstance().person("Mary", 21, 'F');
        SocialPerson p3 = PhysicalObjectPool.getInstance().person("Tom", 33, 'M');
        SocialPerson p4 = PhysicalObjectPool.getInstance().person("Pat", 44, 'F');
    ...
    @Test
    public void testAddRelation2() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();
    ...
    @Test
    public void testAddRelation3() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();
    ...
    @Test
    public void testRemoveRelation() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();
     ...
     */
    @Test
    public void testRemoveRelation2() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();
    ...
    @Test
    public void testRemovePerson() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();
    ...
    @Test
    public void testDistance() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();
    ...
    @Test
    public void testCalculateDiffusion() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();
    ...
    @Test
    public void testSources() throws ObjectNotExistException {
        SocialNetworkCircle circle = newInstance();
