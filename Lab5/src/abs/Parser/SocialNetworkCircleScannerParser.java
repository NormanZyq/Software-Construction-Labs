...
public final class SocialNetworkCircleScannerParser extends SocialNetworkCircleParser {

    /**
     * logger for this class.
     */
    private Logger log = Logger.getLogger(SocialNetworkCircleScannerParser.class);
    ...
    @Override
    public final OrbitAble<?, ?> parse(final File file) throws FileNotFoundException, OrbitFileParseException {
...
//                        friends.add(person);
        ...
        scanner.close();
        log.info(file.getName() + "文件读取并解析已完成，花费时间：" + (time2 - time1));
